Feature: CURO1515 Validar Licencia de Conducción Instructor
    ...
    Scenario: EP1_CUR01515_OA: Licencia de conducción activa y vigente
        ...
        And   Se revisa la tabla de donde se guarda el log para mirar la cantidad de registros antes de consumir el servicio
        ...
        And Se revisa la tabla de donde se guarda el log para mirar la cantidad de registros al consumir el servicio
        And Se debe registrar correctamente el log del caso de uso en la base de datos
